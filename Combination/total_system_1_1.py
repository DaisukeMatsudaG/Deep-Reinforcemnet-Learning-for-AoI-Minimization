...
#result_dir_2 = '/content/drive/MyDrive/modi_env/improve_R_MADQN/epsilon/5state_1recurrent/modify/200/SN'+str(args.amount_SN)+'/'+str(file_name_2)
...
class AoI(gym.Env): # (1)
    ...
    def step(self, action_1, action_2):
        ...
        if  (150<=self.agent_pos_1[0]<=250 and 0<=self.agent_pos_1[1]<=100) or (150<=self.agent_pos_1[0]<=250 and 300<=self.agent_pos_1[1]<=400) or (0<=self.agent_pos_1[0]<=100 and 150<=self.agent_pos_1[1]<=250) or (300<=self.agent_pos_1[0]<=400 and 150<=self.agent_pos_1[1]<=250):
          self.state_list_3 = [self.time_slot,self.agent_pos_1[0],self.agent_pos_1[1]]
        ...
        #遠隔制御判定_UAV_2
        if  (150<=self.agent_pos_2[0]<=250 and 0<=self.agent_pos_2[1]<=100) or (150<=self.agent_pos_2[0]<=250 and 300<=self.agent_pos_2[1]<=400) or (0<=self.agent_pos_2[0]<=100 and 150<=self.agent_pos_2[1]<=250) or (300<=self.agent_pos_2[0]<=400 and 150<=self.agent_pos_2[1]<=250):
          self.state_list_4 = [self.time_slot,self.agent_pos_2[0],self.agent_pos_2[1]]
          for iS in range(amount_SN):
