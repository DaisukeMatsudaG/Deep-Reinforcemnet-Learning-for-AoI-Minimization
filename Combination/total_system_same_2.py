...
class ActionStateModel:
    ...
    def hidden_2_outputs(self,return_state,state_2_list):
        ...
        return self.hidden_layer_model_2.predict_on_batch(state_2_list_append)
    ...
    def test_get_action_1(self, return_state, state_list):
        ...
        q_value = self.model_1.predict_on_batch(state_list_append)[0]#まじでここpredictじゃない方がええ気がしてますぅ。
    ...
    def test_get_action_2(self, return_state, state_list):
        ...
        state_list_append = np.append(state_list,return_state)
        state_list_append = np.reshape(state_list_append, [1, len(state_list_append)])
        q_value = self.model_2.predict_on_batch(state_list_append)[0]#まじでここpredictじゃない方がええ気がしてますぅ。
        res_outputs = res_output_layers(q_value,res_actions_list)
        action = choose_res_action(res_outputs)
        return action#argminへの変更も忘れずに！！]
...
file_name_1 = '1_0_e_4_timeslot'
result_dir_1 = '/content/drive/MyDrive/modi_env/improve_R_MADQN/epsilon/5state_1reccurent/modify/200/SN'+str(args.amount_SN)+'/'+str(file_name_1)
file_name_2 = '1_0_e_4_timeslot'
result_dir_2 = '/content/drive/MyDrive/modi_env/improve_R_MADQN/epsilon/5state_1reccurent/modify/200/SN'+str(args.amount_SN)+'/'+str(file_name_2)
file_name = 'another_change_1000_'+str(int(100*args.threshold))+'_'+str(args.duration_threshold)+'_first_and_first'
#file_name ='check'
result_dir = '/content/drive/MyDrive/modi_env/total_system/SN'+str(args.amount_SN)+'/R_MADQN_and_R_MADQN/'+str(file_name)
if not os.path.exists(result_dir):
    os.mkdir(result_dir)
def main_1_1():
...
file_name_1 = '1_0_e_4_timeslot_again'
result_dir_1 = '/content/drive/MyDrive/modi_env/improve_R_MADQN/epsilon/5state_1reccurent/modify/200/SN'+str(args.amount_SN)+'/'+str(file_name_1)
file_name_2 = '1_0_e_4_timeslot'
result_dir_2 = '/content/drive/MyDrive/modi_env/improve_R_MADQN/epsilon/5state_1reccurent/modify/200/SN'+str(args.amount_SN)+'/'+str(file_name_2)
...
file_name_1 = '1_0_e_4_timeslot_third'
result_dir_1 = '/content/drive/MyDrive/modi_env/improve_R_MADQN/epsilon/5state_1reccurent/modify/200/SN'+str(args.amount_SN)+'/'+str(file_name_1)
file_name_2 = '1_0_e_4_timeslot'
result_dir_2 = '/content/drive/MyDrive/modi_env/improve_R_MADQN/epsilon/5state_1reccurent/modify/200/SN'+str(args.amount_SN)+'/'+str(file_name_2)
