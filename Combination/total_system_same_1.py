...
result_dir_1 = '/content/drive/MyDrive/modi_env/no_DQN_for_MARL/epsilon/SN'+str(args.amount_SN)+'/'+str(file_name_2)
result_dir_2 = '/content/drive/MyDrive/modi_env/no_DQN_for_MARL/epsilon/SN'+str(args.amount_SN)+'/'+str(file_name_2)
result_dir = '/content/drive/MyDrive/modi_env/total_system/SN'+str(args.amount_SN)+'/No_DQN_for_MARL_and_No_DQN_for_MARL/'+str(file_name)
...
class ActionStateModel:
    def __init__(self, state_dim, aciton_dim):
        ...
        self.model_1 = self.create_model_2()
        self.model_2 = self.create_model_2()
...
result_dir_1 = '/content/drive/MyDrive/modi_env/no_DQN_for_MARL/epsilon/SN'+str(args.amount_SN)+'/'+str(file_name_1)
result_dir_2 = '/content/drive/MyDrive/modi_env/no_DQN_for_MARL/epsilon/SN'+str(args.amount_SN)+'/'+str(file_name_2)
result_dir = '/content/drive/MyDrive/modi_env/total_system/SN'+str(args.amount_SN)+'/No_DQN_for_MARL_and_No_DQN_for_MARL/'+str(file_name)
if not os.path.exists(result_dir):
    os.mkdir(result_dir)
...
file_name_1 = '1_0_e_3_timeslot_again'
file_name_2 = '1_0_e_3_timeslot'
...
file_name_1 = '1_0_e_3_timeslot_third'
file_name_2 = '1_0_e_3_timeslot'
