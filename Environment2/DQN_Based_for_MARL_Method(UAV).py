...
#file_name = 'test'
result_dir = '/content/drive/MyDrive/modi_env/no_DQN_for_MARL/epsilon/SN'+str(args.amount_SN)+'/'+str(file_name)
...
class ActionStateModel:
    ...
    def __init__(self, state_dim, aciton_dim):
        self.state_dim  = 1+2*2+args.amount_SN
    ...
    def get_action_1(self, state_1):
        state_1 = np.reshape(state_1, [1, self.state_dim-2])
    ...
    def get_action_2(self, state_2):
        state_2 = np.reshape(state_2, [1, self.state_dim-2])
...
class Agent:
    ...
    def __init__(self, env):
        ...
        self.model = ActionStateModel(self.state_dim-2, self.action_dim)
        self.target_model = ActionStateModel(self.state_dim-2, self.action_dim)
